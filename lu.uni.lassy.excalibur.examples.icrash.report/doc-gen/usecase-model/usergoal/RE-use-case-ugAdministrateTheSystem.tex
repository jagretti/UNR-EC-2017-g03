...
\addnumberedsinglerow{}{\msrucname{oeAddHospital [0..*]}}
\addnumberedsinglerow{}{\msrucname{oeDeleteHospital [0..*]}}
...
\addalphanumberedsinglerow{}{the actor \msrcode{actAdministrator} executes the \msrucname{oeAddHospital} use case}
\addalphanumberedsinglerow{}{the actor \msrcode{actAdministrator} executes the \msrucname{oeDeleteHospital} use case}
...
\addnumberedsinglerow{}{steps (a) (b) and (c) executions are interleaved 
          (steps (b) (c) (d) and (e) have their protocol constrained 
           by steps of (a)).}
\addnumberedsinglerow{}{steps (a) (b) (c) (d) and (e) can be executed multiple times.}
