...
\begin{actortable}
	...
	\addnumbereddoublerow{OUT}{\hypertarget{actAdministrator.outactAdministrator.oeAddHospital}
			{\msrcode{oeAddHospital(AdtHospitalID:dtHospitalID, AdtGPSLocation:dtGPSLocation):ptBoolean}}}
			{ }
	\addnumbereddoublerow{OUT}{\hypertarget{actAdministrator.outactAdministrator.oeDeleteHospital}
			{\msrcode{oeDeleteHospital(AdtHospitalID:dtHospitalID):ptBoolean}}}
			{ }
	...
	\addnumbereddoublerow{IN}{\msrcode{ieHospitalAdded(AdtHospitalID:dtHospitalID):ptBoolean}}
							 { }
	\addnumbereddoublerow{IN}{\msrcode{ieHospitalDeleted(AdtHospitalID:dtHospitalID):ptBoolean}}
							 { }
