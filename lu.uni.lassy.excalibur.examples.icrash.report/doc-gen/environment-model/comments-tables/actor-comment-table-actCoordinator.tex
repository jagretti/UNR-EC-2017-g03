...
\begin{actortable}
	...
	\addnumbereddoublerow{OUT}{\hypertarget{actCoordinator.outactCoordinator.oeSendHospitalInfo}
			{\msrcode{oeSendHospitalInfo(AdtHospitalInfo:dtHospitalInfo, AdtCrisisID:dtCrisisID):ptBoolean}}}
			{ }
	...
	\addnumbereddoublerow{IN}{\msrcode{ieSendAlerts(ActAlerts:Set(ctAlert)):ptBoolean}}
							 { }
	\addnumbereddoublerow{IN}{\msrcode{ieValidateAlert(AdtAlertID:dtAlertID):ptBoolean}}
							 { }
	\addnumbereddoublerow{IN}{\msrcode{ieInvalidateAlert(AdtAlertID:dtAlertID):ptBoolean}}
							 { }
