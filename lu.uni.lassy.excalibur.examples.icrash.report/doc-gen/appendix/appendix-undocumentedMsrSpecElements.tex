...
\begin{itemize}
\item icrash.concepts.primarytypes.classes.ctHospital 
\end{itemize}

\subsection[Undocumented Primary Datatype Types]{Undocumented Primary Datatype Types}
\begin{itemize}
\item icrash.concepts.primarytypes.datatypes.dtHospitalID 
\item icrash.concepts.primarytypes.datatypes.dtQtyVictims 
\end{itemize}

\subsection[Undocumented Primary Enumeration Types]{Undocumented Primary Enumeration Types}
\begin{itemize}
\item icrash.concepts.primarytypes.datatypes.etSeverity 
\end{itemize}
...
\item icrash.environment.actCoordinator.outactCoordinator.oeSendHospitalInfo 
\end{itemize}
