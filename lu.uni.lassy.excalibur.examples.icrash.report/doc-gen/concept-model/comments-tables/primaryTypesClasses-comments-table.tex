...
\addsingletwocolumnrow{extends}{icrash.concepts.primarytypes.classes.ctAlertAC}
\adddoubletwocolumnrow{operation}{\msrcode{init(Aid:dtAlertID, Astatus:etAlertStatus, Alocation:dtGPSLocation, Ainstant:dtDateAndTime, Acomment:dtComment, AdtHash:dtHash):ptBoolean}}{used to initialize the current object as a new instance of the ctAlert type.}
\adddoubletwocolumnrow{operation}{\msrcode{init(Aid:dtAlertID, Astatus:etAlertStatus, Alocation:dtGPSLocation, Ainstant:dtDateAndTime, Acomment:dtComment, AdtHash:dtHash):ptBoolean}}{ }
\adddoublerow{ctAlertAC}{Represent an abstract class of an Alert}
...
\adddoubletwocolumnrow{attribute}{\msrcode{hash: dtHash}}{ }
...
\adddoublerow{ctAlertBackup}{Represents the backup of an alert}
\addsingletwocolumnrow{extends}{icrash.concepts.primarytypes.classes.ctAlertAC}
\adddoubletwocolumnrow{operation}{\msrcode{init(Aid:dtAlertID, Astatus:etAlertStatus, Alocation:dtGPSLocation, Ainstant:dtDateAndTime, Acomment:dtComment, AdtHash:dtHash):ptBoolean}}{}
...
\adddoublerow{ctHospital}{This class is used to represent a hospital in the system}
\adddoubletwocolumnrow{attribute}{\msrcode{attLocation: dtGPSLocation}}{}
\adddoubletwocolumnrow{attribute}{\msrcode{id: dtHospitalID}}{ }
...
\adddoubletwocolumnrow{operation}{\msrcode{isAcknowledged():ptBoolean}}{ }
